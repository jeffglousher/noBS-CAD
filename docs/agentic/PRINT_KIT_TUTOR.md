...
| Rotor | Root plate out to the blades, socket over the bushing flange, 3 helical **NACA 0021** ending on that plate, **one body**, open drafted tips | Bore = bushing OD + friction. Not the outer race. Print standing on the plate. PLA Glow. |
