...
- Print-kit tutor (**benchmark #1**): [INTEGRATION_TESTS.md](INTEGRATION_TESTS.md), `scripts/fixtures/print-kit-tutor.spec.json`, `npm run test:mcp-print-kit`, `cargo test print_kit_tutor`
