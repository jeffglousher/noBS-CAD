...
| Resources / prompts | Main-surface `nbcad://` reads (document, scene, sketch, profiles, features, drawing, workspace, …) and recipes (box, solid, STEP, drawing export, undo, invoke) |
