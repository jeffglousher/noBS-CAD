...
| Resources / prompts | Main-surface `nbcad://` reads (document, scene, sketch, profiles, features, drawing, workspace, …) and recipes (box, solid, printable tool, print-kit tutor, STEP, drawing export, undo, invoke) |
