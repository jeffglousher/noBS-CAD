...
A directionless helical H-Darrieus (VAWT). Three identical **NACA 0021**
blades, 120° apart, 60° helix from a 30° root, chord tangent, mid-chord on
radius R. Open tips with a short taper to a flat landing. Organic fatter
root on the plate top; through-plate stump is the sit-plane chord.
...
| Rotor | Thin root plate (underside = upper thrust race) + 3 helical NACA 0021. One body. Plate bore larger than journal pass Ø | Standing on the plate |
| Rollers | 6 radial-axis cylinders, min Ø8, pack height = Ø, PCD under the blade roots. Drop into top-load slots | Standing (axis Z) |
...
3. Rotor: root plate, airfoil through the plate, `solid_loft` three helical
   NACA 0021 from the organic root to a tapered flat landing.
4. Six radial-axis rollers. Top-load slots on the stator.
...
Include: architecture, NACA 0021 citation, solidity, fit table, thrust-pack
