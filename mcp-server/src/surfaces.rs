        ...
        "model_print_kit" => {
            ...
            format!(
                "CAD synthesis tutor — build a fully printed even spinner as an assembled stack, then grade FDM tolerancing.\n\
                 ...
                 6. Rotor: hub Ø20 / Ø8.4 that sits on the shoulder (do not swallow the shoulder), double-D 6.4, plus two helical buckets at 180° joined to the hub. A lone C-loft coupon is not a rotor. Sweep must clear the posts (R38 inner wall).\n\
                 7. Top plate Ø90 × 6 at z=30 (above the rotor + 2 mm gap). Ø8.4 post holes that actually locate. Bushing seat Ø14.4 × 4 from the top so a 2 mm land remains. Printed bushing Ø8.4/Ø14 × 4 on that land. Cap Ø20 with 0.20 float. Functional holes are XY circles. Disable grid snap. Prefer locked circles.\n\
                 8. cad_set_focus print. set_body_appearance. solid_export_preflight. solid_export_3mf slicer_target=bambu_studio.\n\
                 9. Grade: timeline ok, ≥6 coaxial bodies, posts through plate, cone/land thrust, double-D drive, even 3+2 layout, mounted rotor, 3MF is a PK zip.\n\
